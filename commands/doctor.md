---
description: "hi-vibe's own health check — actually runs hi-vibe's 6 hook scripts & scanner to catch silent failure. Not Claude Code's built-in /doctor (that one checks your CLI install)"
...
1. First line: 이 프로젝트에서 hi-vibe가 제대로 도나? (python3 + 훅 스크립트 6개 +
