...
### 👉 [무엇을 해주는지 소개 사이트에서 보기](https://jx-hxxx.github.io/hi-vibe/?lang=ko)
...
| 비교 가능한 전후 수치가 나오면 | 명령·환경·표본과 함께 `evidence/METRICS.md`에 근거 기록 |
...
- **hi-vibe는 대화나 코드를 별도 서버로 보내지 않습니다.** 외부 통신이 아예
  없어요(Claude Code 자체의 데이터 처리는 Anthropic 정책을 따릅니다 — 그건
  이 플러그인이 정하는 부분이 아닙니다). 다만 최근 요청 5개(각 120자)와 수정
  파일 목록이 프로젝트 안 `handover.md`에 **평문으로** 남습니다(기본
...
- **[소개 사이트](https://jx-hxxx.github.io/hi-vibe/?lang=ko)** — 전체 명령어 · 작동 원리 · 기록되는 것 · FAQ · 적합성 평가 질문
